...
/**
 * A {@link Dialog} with a header, {@link com.google.android.material.datepicker.MaterialCalendar}, and set of actions.
 */
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private final LinkedHashSet<OnClickListener> onNegativeButtonClickListeners =
            new LinkedHashSet<>();
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        @SuppressLint("RestrictedApi") int surfaceColor =
                MaterialAttributes.resolveOrThrow(
    ...
    private void updateToggleContentDescription(@NonNull CheckableImageButton toggle) {
        @SuppressLint("RestrictedApi") String contentDescription =
                headerToggleButton.isChecked()
    ...
    public static final class Builder<S> {
        ...
        /**
         * Sets the Builder's selection manager to the provided {@link com.google.android.material.datepicker.DateSelector}.
         *
         * @hide
         */
        @RestrictTo(LIBRARY_GROUP)
