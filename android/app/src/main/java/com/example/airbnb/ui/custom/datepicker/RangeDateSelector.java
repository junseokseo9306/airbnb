...
/**
 * A {@link com.google.android.material.datepicker.DateSelector} that uses a {@link Pair} of {@link Long} objects to represent a selected
 * range.
 *
 * @hide
 */
...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
     ...
     * {@link Creator}
     */
    public static final Creator<RangeDateSelector> CREATOR =
            new Creator<RangeDateSelector>() {
                @NonNull
                @Override
    ...
    public String getSelectionDisplayString(@NonNull Context context) {
        ...
        Pair<String, String> dateRangeStrings = DateStrings.getDateRangeString(selectedStartItem, selectedEndItem);
        return res.getString(
